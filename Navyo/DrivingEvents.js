  ...
  render () {
    return (
      ...
      <View style={styles.datetime}>
        ...
        <TouchableOpacity style={styles.datetimeText} onPress={this._showDateTimePicker1}>
    ...
    <TouchableOpacity style={styles.datetimeText} onPress={this._showDateTimePicker2}>
